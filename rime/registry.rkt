...
(define rime-entries
  (list
   ...
   (entry "cangjie5" #:deps '("luna-quanpin")
          #:extra-files '("cangjie5.dict.yaml")
          #:keyboard-layouts '("cangjie6"))
   (entry "cangjie5-express" #:source-id "cangjie5_express" #:deps '("luna-quanpin")
          #:extra-files '("cangjie5.dict.yaml")
          #:keyboard-layouts '("cangjie6"))
   ...
   (entry "wubi-trad" #:source-id "wubi_trad" #:deps '("pinyin-simp")
          #:extra-files '("wubi86.dict.yaml")
          #:keyboard-layouts '("wubi86"))
   (entry "quick5" #:deps '("luna-quanpin")
   ...
   (entry "luna-quanpin" #:source-id "luna_quanpin" #:deps '("luna-pinyin")
          #:extra-files '("pinyin.yaml")
          #:keyboard-layouts '("luna_pinyin"))))
